  ...
  <p>Welcome to {appName}!</p>
        ...
        <p>
          These terms and conditions outline the rules and regulations for the use
            of {appName}&apos;s Website, located at flextransformation.com.
        </p>
        ...
        <p>
          We employ the use of cookies. By accessing {appName}, you agree to use
          cookies in agreement with {appName}&apos;s Privacy Policy.
        </p>
        ...
        <p>
          ...
          intellectual property rights are reserved. You may access this from {appName} for your own personal use subjected to restrictions set in these
          terms and conditions.
        </p>
        ...
        <p>
          ...
          exchange opinions and information in certain areas of the website. {appName} does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and opinions
          of {appName}, its agents and/or affiliates. Comments reflect the views
          and opinions of the person who post their views and opinions. To the
          extent permitted by applicable laws, {appName} shall not be liable for
